...
store rate of interest in varaible
'''
...
'''
Combine Class Employee with class month because both related one application/task
'''
...
print("employee_name : ",Month.name)
...
Month.add_rate_of_interest(10)
print("rate_of_interest : ",Month.rate_of_interest)
