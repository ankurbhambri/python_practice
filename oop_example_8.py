...
After 6 months of releasing this code, we got requirement to add new feature
add_phone_bill
...
print("employee_name : ",New_Month.name)
...
New_Month.add_rate_of_interest(10)
print("rate_of_interest : ",New_Month.rate_of_interest)
